-- Public restricted survey fill links.
-- The token is stored inside surveys.data and access is exposed only through
-- SECURITY DEFINER RPCs that validate the token before reading/updating.
